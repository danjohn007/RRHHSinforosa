<div class="fade-in max-w-3xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-600">Complete el formulario para crear un nuevo usuario del sistema</p>
    </div>
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <select id="rol" 
                        ...
                        <option value="rrhh" <?php echo (($_POST['rol'] ?? '') == 'rrhh') ? 'selected' : ''; ?>>RRHH</option>
                        ...
                        <option value="socio" <?php echo (($_POST['rol'] ?? '') == 'socio') ? 'selected' : ''; ?>>Socio</option>
                        <option value="empleado_confianza" <?php echo (($_POST['rol'] ?? '') == 'empleado_confianza') ? 'selected' : ''; ?>>Empleado de Confianza</option>
                    </select>
                    ...
                    <select id="empleado_id" 
                        ...
                        <?php foreach ($empleadosDisponibles as $empleado): ?>
                            <option value="<?php echo $empleado['id']; ?>" 
                                    <?php echo (($_POST['empleado_id'] ?? '') == $empleado['id']) ? 'selected' : ''; ?>>
