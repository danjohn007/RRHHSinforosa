            ...
            <nav class="flex-1 overflow-y-auto p-4">
                <div class="space-y-1">
                    ...
                    <div class="mt-4">
                        ...
                        <a href="<?php echo BASE_URL; ?>configuraciones/dispositivos" class="sidebar-item flex items-center px-4 py-3 rounded-lg transition">
                            <i class="fas fa-microchip w-5"></i>
                            <span class="ml-3">Dispositivos IoT</span>
                        </a>
                    </div>
                    <?php endif; ?>
                </div>
